            ...
            <ul class="list-unstyled">
                <?php if (isset($_SESSION['user_role'])): ?>
                    ...
                    <?php if ($_SESSION['user_role'] === 'Alumni'): ?>
                        <li class="h7"><a class="nav-link" href="alumni_home.php"><i class="fal fa-user-graduate me-2"></i> Your Profile</a></li>
                        <li class="h7"><a class="nav-link" href="edit_form.php"><i class="fal fa-edit me-2"></i> Edit Profile</a></li>
                    <?php endif; ?>
                    ...
                    <?php if (hasAccess('dean_list.php')): ?>
                        <li class="h7"><a class="nav-link" href="dean_list.php"><i class="far fa-graduation-cap me-2"></i><?= htmlspecialchars($userCollege ?? 'N/A') ?> List</a></li>
                    <?php endif; ?>
                    <?php if (hasAccess('programchair_list.php')): ?>
                        <li class="h7"><a class="nav-link" href="programchair_list.php"><i class="far fa-graduation-cap me-2"></i><?= htmlspecialchars($userDepartment ?? 'N/A') ?> List</a></li>
                    <?php endif; ?>
                <?php else: ?>
